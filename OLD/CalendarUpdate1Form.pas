...
type
  TFormUpdate1Calendar = class(TForm)
    ...
    XBillUpdate1Calendar: TUniQuery;
    UniDataSource1: TDataSource;
    XBillUpdate1Calendarfull_name: TStringField;
    XBillUpdate1Calendaruser: TStringField;
    XBillUpdate1Calendarpassword: TStringField;
    XBillUpdate1Calendarrole_id: TStringField;
    XBillUpdate1Calendaris_active: TBooleanField;
    XBillUpdate1Calendarhiring_date: TDateField;
    XBillUpdate1Calendarclosure_date: TDateField;
    XBillUpdate1Calendaris_working: TStringField;
    XBillUpdate1Calendaruser_id: TLargeintField;
    XBillUpdate1Calendarlang_is_active: TStringField;
    procedure BitBtnCloseClick(Sender: TObject);
    procedure BitBtnEditClick(Sender: TObject);
    procedure XBillUpdate1CalendarCalcFields(DataSet: TDataSet);
...
procedure TFormUpdate1Calendar.XBillUpdate1CalendarCalcFields(DataSet: TDataSet);
begin
if UniSQLUsers['is_active']
