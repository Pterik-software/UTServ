...
require_once dirname(__FILE__) . '/' . 'database_engine/sqlite_engine.php';
...
{
    $result = array();
    $result[] = array('caption' => 'Accounts', 'short_caption' => 'Accounts', 'filename' => 'accounts.php', 'name' => 'accounts', 'group_name' => 'Default', 'add_separator' => true, 'description' => '');
    $result[] = array('caption' => 'Address Types', 'short_caption' => 'Address Types', 'filename' => 'address_types.php', 'name' => 'address_types', 'group_name' => 'Default', 'add_separator' => true, 'description' => '');
    $result[] = array('caption' => 'Addresses', 'short_caption' => 'Addresses', 'filename' => 'addresses.php', 'name' => 'addresses', 'group_name' => 'Default', 'add_separator' => true, 'description' => '');
    return $result;
}
...
{
    return
        '<div class="alert alert-danger SQLGeneratorEvaluationVersion"><h3 class="SQLGeneratorEvaluationVersion-head">This website was created by evaluation version of <a href="http://www.sqlmaestro.com/products/sqlite/phpgenerator/" class="alert-link">SQLite PHP Generator Professional</a>.</h3><img class="SQLGeneratorEvaluationVersion-justify" src="components/assets/img/btn-loading.png"></div>';
}

function GetPagesFooter()
{
    return
        '<p align="right">(C) <span>2002-<script type="text/javascript">document.write(new Date().getFullYear().toString())</script></span><a href="http://www.sqlmaestro.com/products/sqlite/phpgenerator/"> SQL Maestro Group</a>.</p>';
}
...
function createConnection()
{
    ...
    $connectionFactory = SqlitePDOConnectionFactory::getInstance();
