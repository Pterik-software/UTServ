 ...
 */
    ...
    class addressesPage extends Page
    {
        ...
        protected function setupFilterBuilder(FilterBuilder $filterBuilder, FixedKeysArray $columns)
        {
            ...
            $main_editor->SetHandlerName('filter_builder_addresses_address_type_id_search');
            
            $multi_value_select_editor = new RemoteMultiValueSelect('address_type_id', $this->CreateLinkBuilder());
            $multi_value_select_editor->SetHandlerName('filter_builder_addresses_address_type_id_search');
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $editColumn = new DynamicLookupEditColumn('Address Type Id', 'address_type_id', 'address_type_id_address_type', 'edit_addresses_address_type_id_search', $editor, $this->dataset, $lookupDataset, 'address_type', 'address_type', '');
        ...
        protected function AddMultiEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('address_type', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Address Type Id', 'address_type_id', 'address_type_id_address_type', 'multi_edit_addresses_address_type_id_search', $editor, $this->dataset, $lookupDataset, 'address_type', 'address_type', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
        ...
        protected function AddInsertColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('address_type', 'ASC');
            $editColumn = new DynamicLookupEditColumn('Address Type Id', 'address_type_id', 'address_type_id_address_type', 'insert_addresses_address_type_id_search', $editor, $this->dataset, $lookupDataset, 'address_type', 'address_type', '');
            $editColumn->SetAllowSetToNull(true);
            $this->ApplyCommonColumnEditProperties($editColumn);
            $grid->AddInsertColumn($editColumn);
        ...
        protected function doRegisterHandlers() {
            ...
            $lookupDataset->setOrderByField('address_type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'insert_addresses_address_type_id_search', 'address_type', 'address_type', null, 20);
            ...
            $lookupDataset->setOrderByField('address_type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'filter_builder_addresses_address_type_id_search', 'address_type', 'address_type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('address_type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'edit_addresses_address_type_id_search', 'address_type', 'address_type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $lookupDataset->setOrderByField('address_type', 'ASC');
            $handler = new DynamicSearchHandler($lookupDataset, $this, 'multi_edit_addresses_address_type_id_search', 'address_type', 'address_type', null, 20);
            GetApplication()->RegisterHTTPHandler($handler);
        }
    ...
    try
    {
        $Page = new addressesPage("addresses", "addresses.php", GetCurrentUserPermissionsForPage("addresses"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("addresses"));
